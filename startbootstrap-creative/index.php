...
<head>
  ...
  <meta name="description" content="Recreational kickball league in Amsterdam">
  <meta name="keywords" content="kickball, amsterdam, netherlands, nederland, NL, rec league, recreation, social league">
  <meta name="author" content="Max Struever">

  <link rel="icon" type="image/png" sizes="96x96" href="./img/favicon-96x96.png">
  <link rel="icon" type="image/png" sizes="16x16" href="./img/favicon.ico">

  <title>Kickball in Amsterdam! | Kickball NL</title>
...
<body id="page-top">
  ...
  <nav id="mainNav" class="navbar fixed-top navbar-toggleable-md navbar-light">
    ...
    <div class="container">
      <a class="navbar-brand page-scroll" href="#page-top">Kickball in Amsterdam</a>
      <div class="collapse navbar-collapse" id="navbarExample">
        <ul class="navbar-nav ml-auto">
          ...
          <li class="nav-item">
            <a class="nav-link page-scroll" href="#services">About Kickball</a>
          </li>
...
<!--           <a href="#services" class="page-scroll btn btn-default btn-xl sr-button">Get Started!</a> -->
    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-12 text-center">
          <h2 class="section-heading">About Kickball</h2>
          <hr class="primary">
        </div>
      </div>
    </div>
  ...
  <section class="no-padding hidden-xs-up" id="portfolio">
    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-8 offset-lg-2 text-center">
          ...
          <hr class="primary">
          <p>We'd prefer that you reach out to us via filling out <a href="https://goo.gl/forms/6OTnEYXRRPOrDdY43" target="_blank">this form</a> to show your interest. But if you want, you can also email us!</p>
        </div>
        ...
        <div class="col-lg-4 text-center">
          ...
          <p><a href="mailto:your-email@your-domain.com">info@kickball.nl</a></p>
        </div>
      </div>
    </div>
  </section>
